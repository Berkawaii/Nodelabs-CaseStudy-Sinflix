...
class _MovieApiService implements MovieApiService {
  ...
  @override
  Future<ApiMovieResponse> getMovies({required int page}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiMovieResponse>(
    ...
    late ApiMovieResponse _value;
    try {
      _value = ApiMovieResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
